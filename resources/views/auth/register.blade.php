...
<body>
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
            ...
            <div class="position-relative d-none d-lg-block width-left" style="height: 100%;">
                <img class="position-absolute img-fluid centered"
                    src="{{ asset('./assets/images/ilustration/il-login.png') }}"
                    alt="" />
            </div>
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <form style="margin-top: 1.5rem" action="{{ route('register') }}" method="post">
                        @csrf
                        <div style="margin-bottom: 1.75rem">
                            <label for="" class="d-block input-label">Nama Lengkap</label>
                            <div class="d-flex w-100 div-input">
                                <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 1rem" width="24" height="24" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z" fill="#CACBCE"/>
                                  </svg>
                                <input class="input-field border-0" type="text" name="name" id=""
                        ...
                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="email" name="email" id=""
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="password_confirmation"
                                    id="password-content-3-5" placeholder="Your Password" minlength="6" required />
                                <div onclick="togglePassword()">
                                    <svg style="margin-left: 0.75rem; cursor: pointer" width="20" height="14"
                                        viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
